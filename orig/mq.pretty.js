...
(function(){
    var J={
        ...
        $package:function(ns,func){
            ...
            //@ PATCH
            if (typeof a == "string")
                window.modules[a] = Object.assign({}, target)
        },
...
//联系人model类
    J.$package("mq.model.buddylist",function(J){
        ...
        //数据列表
        var categoriesList = [],groupList = [],recentList = [],friendsList = [],discussList = [] ,sigList = [] ,id2category = {},uin2Friend = window.uin2friend = {} ,gid2group = window.gid2group = {} ,id2discuss = window.id2discuss = {} ,uin2sig = {},strangerList = [],uin2stranger={};
