...
ws.onmessage = data => {
    try {
        ...
        case 'send_text_message':
            ...
            else if (buddylist.getGroups()[data.receiver])
...
J.$package(function(g) {
    g.connectType = ["unknow", "ethernet", "wifi", "cell_2g", "cell_3g"][(navigator.connection || {
        type: 0
    }).type]
});
J.$package(function(g) {
        ...
        bindCommands: function(q, w, C, h) {
            ...
            if (q._commends[w])
                ...
                g.event.on(q, w, function(v) {
                    ...
                    if (D) {
                        var p = D.getAttribute(h)
                          , y = D.getAttribute("param");
    ...
    var d = function(q) {
      ...
      , z = {
        _fire: function(q, w, C) {
            g.each(B, function(h) {
                h.ele == q && w == h.evtType && C == h.handler && C.call(q, {
                    type: w
                })
            })
        },
...
J.$package(function(g) {
    ...
    g.Util = {
        ...
        scrollToTop: function(f, n) {
            ...
            g.Animation
              , r = document.body
              , k = window.pageYOffset || document.body.scrollTop || document.documentElement.scrollTop;
...
J.$package(function(g) {
    var a = {
        ...
        ajax: function(b) {
            var c = b.method.toLocaleUpperCase()
              , e = "POST" == c
              , j = false
              , f = b.timeout
              , n = b.withCredentials
              , m = "async" in b ? b.async : true
              , r = window.XMLHttpRequest ? new XMLHttpRequest : false;
            if (!r) {
                b.error && 
                b.error.call(null , {
                    ret: 999,
...
(function(g, a) {
    ...
    var P = function() {
      ...
      , E = g.cancelRequestAnimationFrame || g.webkitCancelAnimationFrame || g.webkitCancelRequestAnimationFrame || g.mozCancelRequestAnimationFrame || g.oCancelRequestAnimationFrame || g.msCancelRequestAnimationFrame || clearTimeout
      , G = w ? " translateZ(0)" : ""
      , O = function(u, s) {
        var A = this, K;
    ...
    O.prototype = {
        ...
        _move: function(u) {
            var s = C ? u.touches[0] : u
              , A = s.pageX - this.pointX
              , K = s.pageY - this.pointY
              , L = this.x + A
              , Q = this.y + K
              , R = u.timeStamp || Date.now();
            ...
            if (this.options.zoom && C && u.touches.length > 1) {
                ...
                if (Q > this.minScrollY || Q < this.maxScrollY)
                    Q = this.options.bounce ? this.y + K / 2 : Q >= this.minScrollY || this.maxScrollY >= 0 ? this.minScrollY : this.maxScrollY;
                this.distX += A;
                this.distY += K;
        ...
        _end: function(u) {
            if (!(C && u.touches.length !== 0)) {
                var s = this, A = C ? u.changedTouches[0] : u, K, L, Q = {
                    dist: 0,
                    time: 0
                }, R = {
                    dist: 0,
                ...
                if (s.zoomed) {
                    ...
                    if (s.moved) {
                        ...
                        300 && s.options.momentum) {
                            ...
                            if (s.y > s.minScrollY && I > s.minScrollY || s.y < s.maxScrollY && I < s.maxScrollY)
                                R = {
                                    dist: 0,
                                    time: 0
                                };
        ...
        _resetPos: function(u) {
            ...
            this.maxScrollX : this.x
              , A = this.y >= this.minScrollY || this.maxScrollY > 0 ? this.minScrollY : this.y < this.maxScrollY ? this.maxScrollY : this.y;
        ...
        _wheel: function(u) {
            ...
            if (s.options.wheelAction == "zoom") {
                ...
                if (K < s.options.zoomMin)
                    K = s.options.zoomMin;
                if (K > s.options.zoomMax)
                    K = s.options.zoomMax;
                if (K != s.scale) {
        ...
        _snap: function(u, s) {
            ...
            A = 0;
            for (K = this.pagesX.length; A < K; A++)
                if (u >= this.pagesX[A]) {
                    L = A;
                    break
                }
...
function pgvIsPgvDomain() {
    var g = Tcss.dm.split(".")
      , a = Tcss.dm;
    return g.length >= 3 && g[g.length - 2] == "qq" && (a = g[g.length - 3]),
    !/(^qzone$)|(^cache$)|(^ossweb-img$)|(^ring$)|(^im$)|(^fo$)|(^shuqian$)|(^photo$)|(^pet$)|(^r2$)|(^bar$)|(^client$)|(^music$)|(^pay$)|(^sg$)|(^vip$)|(^show$)|(^qqtang$)|(^safe$)|(^service$)|(^love$)|(^mail$)|(^qqgamecdnimg$)|(^netbar$)|(^dnf$)|(^qqgame$)|(^mgp$)|(^magic$)|(^city$)|(^1314$)|(^wb$)|(^qun$)|(^aq$)|(^17roco$)|(^minigame$)|(^cf$)|(^zg$)|(^pc$)|(^shurufa$)|(^live$)|(\.3366\.com$)/.test(a)
}
...
function trimUin(g) {
    var a = pvNone;
    return g != pvNone && (g = g.replace(RegExp("[^0-9]", "gm"), ""),
    a = g.replace(RegExp("^0+", "gm"), ""),
    a == "" && (a = pvNone)),
    a
}
function pgvGetNewRand() {
    var g = trimUin(pgvGetCookieByName("uin_cookie="))
      , a = trimUin(pgvGetCookieByName("adid="))
      , b = trimUin(pgvGetCookieByName("uin="))
      , c = trimUin(pgvGetCookieByName("luin="))
      , e = trimUin(pgvGetCookieByName("clientuin="))
      , j = trimUin(pgvGetCookieByName("pt2gguin="))
      , f = trimUin(pgvGetCookieByName("zzpaneluin="))
      , n = trimUin(pgvGetCookieByName("o_cookie="))
      , m = pgvGetCookieByName("pgv_pvid=");
    return n.length > 13 && pgvRealSetCookie("o_cookie="),
    b != pvNone ? (pgvRealSetCookie("o_cookie=" + b),
    "&nrnd=" + 
    b) : c != pvNone ? (pgvRealSetCookie("o_cookie=" + c),
    "&nrnd=" + c) : j != pvNone ? (pgvRealSetCookie("o_cookie=" + j),
    "&nrnd=" + j) : g != pvNone ? (pgvRealSetCookie("o_cookie=" + g),
    "&nrnd=" + g) : n != pvNone ? "&nrnd=" + n : a != pvNone ? (pgvRealSetCookie("o_cookie=" + a),
    "&nrnd=" + a) : e != pvNone ? (pgvRealSetCookie("o_cookie=" + e),
    "&nrnd=" + e) : f != pvNone ? (pgvRealSetCookie("o_cookie=" + f),
    "&nrnd=" + f) : m != pvNone ? "&nrnd=F" + m : "&nrnd=-"
}
function hotClick() {
...
function clickEvent(g) {
    g = g || window.event;
    var a = g.clientX + getScrollXY().x - document.getElementsByTagName("body")[0].offsetLeft
      , b = g.clientY + getScrollXY().y - document.getElementsByTagName("body")[0].offsetTop;
    if (!(a < 0 || b < 0))
        try {
            var c = 1;
...
(function() {
    ...
    g.prototype = {
        ...
        coverCookie: function() {
            if (e.crossDomain && e.crossDomain == "on") {
                var h = this.getParameter("tcss_uid", a.URL)
                  , o = this.getParameter("tcss_sid", a.URL)
                  , v = this.getParameter("tcss_refer", a.URL)
                  , D = this.getParameter("tcss_last", 
                a.URL);
                o && h && (z = 1,
                C.setCookie("ssid", false, o),
                C.save(),
                C.setCookie("ts_refer", true, v),
                C.setCookie("ts_last", true, D),
                C.setCookie("pgv_pvid", true, h))
            }
        },
        getDomainInfo: function(h) {
            var o;
            return o = b.hostname.toLowerCase(),
            e.virtualDomain && (d.push("ad=" + o),
            o = e.virtualDomain),
            this.getCurrentUrl(),
            Tcss.dm = o,
            q && pgvGetDomainInfo(),
            j = Tcss.dm,
            f || (f = this.getCookieSetDomain(b.hostname.toLowerCase()),
            q && (Tcss.domainToSet = f)),
            h && (Tcss.dm += ".hot"),
        ...
        getRefInfo: function(h) {
            ...
            p = o;
            e.virtualRefDomain && (o != "-" && d.push("ard=" + o),
            o = e.virtualRefDomain);
            e.virtualRefURL && (v != "-" && d.push("aru=" + escape(v)),
            v = e.virtualRefURL);
            var F;
            h && (F = o + v,
            o = "ADTAG",
            ...
            Tcss.rarg = escape(D),
            q && pgvGetRefInfo(),
            F ? "&rdm=" + Tcss.rdm + "&rurl=" + Tcss.rurl + "&rarg=" + Tcss.rarg + "&or=" + F : "&rdm=" + Tcss.rdm + "&rurl=" + Tcss.rurl + "&rarg=" + Tcss.rarg
        },
        getMainEnvInfo: function() {
            ...
            try {
                var o = "-"
                  ...
                  , F = 0
                  , H = navigator;
                self.screen && (o = screen.width + "x" + screen.height,
                v = screen.colorDepth + "-bit");
        ...
        getExtendEnvInfo: function() {
            ...
            try {
                ...
                c.addBehavior && (c.addBehavior("#default#homePage"),
                c.isHomePage(o) && (h += "&hp=Y"));
                c.addBehavior && (c.addBehavior("#default#clientCaps"),
                v = c.connectionType);
                h += "&ct=" + v
            } catch (D) {} finally {
                return h
        ...
        getElementPos: function(h) {
            ...
            if (h.getBoundingClientRect) {
                var y, F, H, M;
                return p = h.getBoundingClientRect(),
        ...
        sendClick: function() {
            ...
            this.url.push("&hottag=" + escape(e.hottag)),
            this.url.push("&hotx=9999&hoty=9999"),
            this.url.push("&rand=" + Math.round(Math.random() * 1E5)),
            this.url.unshift("http://pinghot." + this.getCookieSetDomain(j) + "/pingd?"),
            this.sendInfo(this.url.join("")))
        },
        pgvGetArgs: function() {
            this.getDomainInfo();
            var h = [];
            return h.push("tcss_rp_dm=" + Tcss.dm),
            h.push("tcss_uid=" + C.get("pgv_pvid=", true)),
            h.push("tcss_sid=" + C.get("ssid=", true)),
            h.push("tcss_refer=" + C.get("ts_refer=", true)),
            h.push("tcss_last=" + C.get("ts_last=", true)),
            h.join("&")
        },
        sendInfo: function(h) {
            r = new Image(1,1);
    ...
    var C = {
        ...
        getExpires: function(h) {
            var o = new Date;
            return o.setTime(o.getTime() + h * 60 * 1E3),
    ...
    window.pgvMain = function(h, o) {
        var v = "";
        o ? (v = o,
        _ver = "tcsso.3.1.5") : (v = h,
        _ver = "tcss.3.1.5");
        try {
            q && (typeof pvRepeatCount != "undefined" && pvRepeatCount == 1 ? (w = 1,
            pvRepeatCount = 2) : w = 2);
            if (w == 1) {
                w = 2;
                (new g(v)).run()
...
define("../lib/mui/js/mui.slide", ["jm"], function() {
    JM.$package("MUI", function(g) {
        var a = g.dom
          , b = g.event
          , c = "getBoundingClientRect" in document.body
          , e = "-webkit-transform" in document.body.style;
        this.Slide = g.Class({
            init: function(j) {
            ...
            _sizeAdjust: function() {
                var j = this.elem
                  , f = this.count
                  , n = c ? j.getBoundingClientRect().width : j.offsetWidth;
...
define("../lib/mui/js/mui.swipechange", ["jm", "./mui.slide"], function() {
    JM.$package("MUI", function(g) {
        var a = g.dom, b = g.event, c = g.platform.touchDevice, e, j = (c = g.platform.touchDevice) ? "touchstart" : "mousedown", f = c ? "touchmove" : "mousemove", n = c ? "touchend" : "mouseup", m = "getBoundingClientRect" in document.body, r = g.Class({
            extend: MUI.Slide
        }, {
            init: function(k) {
...
define("mq.i18n", ["jm"], function() {
    J.$package("mq.i18n", function(g) {
        var a = (window.navigator.language || window.navigator.browserLanguage).toLowerCase()
          , b = 0;
        if (a)
...
define("mq.view.transitionmanager", ["jm"], function() {
    J.$package("mq.view.transitionManager", function(g) {
        var a = this
          , b = g.support
          , c = {}
          , e = g.prefix && g.prefix.lowercase
          , j = g.prefix && g.prefix.css;
        e || (e = "");
        j || (j = "");
        var f = function(m, r) {
    ...
    J.$package("mq.rpcService", function(g) {
        var a = this, b = JM.event, c = JM.dom, e = mq.DYNAMIC_CGI_URL + "channel/login2", j = mq.DYNAMIC_CGI_URL + "channel/poll2", f = mq.STATIC_CGI_URL + "api/getvfwebqq", n = mq.DYNAMIC_CGI_URL + "channel/refuse_file2", m = mq.DYNAMIC_CGI_URL + "channel/notify_offfile2", r = {
                ...
                this.onAjaxFrameLoad = function() {
                    ...
                    try {
                        if (K.ajax) {
                            ...
                            K = 0;
                            for (var Q = L.length; K < Q; K++)
                                u.proxySend(L[K].url, L[K].option);
                            u._ajaxCallbacks = []
                        }
                    } catch (R) {
            ...
            init: function(E, G) {
                ...
                b.on(O, "load", function() {
                    ...
                    for (var K = u._ajaxCallbacks, L = 0, Q = K.length; L < Q; L++)
                        u.proxySend(K[L].url, K[L].option);
                    u._ajaxCallbacks = []
                });
            ...
            cfProxySend: function(E, G) {
                ...
                if ("postMessage" in window && !g.browser.ie)
                    window.frames[G.iframeName].postMessage(O, u);
                else {
                    var s = c.node("div");
        ...
        this.require = function(E) {
            ...
            E.onSuccess = E.onSuccess || function(L) {
                ...
                window.MM && MM.report(O.split("?")[0], Q || 0, +new Date - K);
                Q === 
                0 ? b.fire(a, u + "Success", L) : b.fire(a, u + "Failure", L)
            }
            ;
        ...
        , L = {
            onGetFriendsListSuccess: function(x) {
                ...
                x.categories || []
                  ...
                  , U = x.info || [];
                x = x.marknames || [];
                for (var V = {}, Y = false, S = 0; S < I.length; S++)
                    if (I[S].index == 0)
                        Y = true;
        ...
        var g = JM.event
          ...
          , c = {
            ...
            onGroupListChange: function(e) {
                b.contactView.memberListAreas.group.render({
                    type: "list",
                    list: e
                })
            },
            onDiscussListChange: function(e) {
                b.contactView.memberListAreas.discuss.render({
                    type: "list",
                    list: e
                })
            },
...
define("mq.model.chat", ["./mq.portal"], function() {
    J.$package("mq.model.chat", function(g) {
        ...
        this.refuseOfflineFile = function(h) {
            mq.rpcService.sendRefuseOfflineFile({
                to: h.from_uin,
                file_name: h.name,
                file_size: h.size,
                action: 2
        ...
        this.nextOfflineFile = function(h) {
            var o = [["nextofffile", '\u60a8\u53d6\u6d88\u4e86\u79bb\u7ebf\u6587\u4ef6"' + h.name + '"\u7684\u63a5\u6536\uff0c\u6211\u4eec\u5c06\u5728\u60a8\u4e0b\u6b21\u767b\u5f55\u540e\u8fdb\u884c\u63d0\u9192\u3002']]
              , v = {
                type: "nextofffile",
                name: h.name,
                from_uin: h.from_uin,
    ...
    J.$package("mq.view.chat", function(b) {
        ...
        this.createPanel = function() {
            if (!this.panel) {
                ...
                d = this.chatTextarea = MUI.AutoGrowTextarea({
                    id: "chat_textarea",
                    maxHeight: 80,
                    initHeight: 32
                });
    ...
    J.$package("mq.presenter.chat", function(g) {
        ...
        128, 129, 130, 131, 132, 133, 134, 136, 137, 138, 139, 140, 141, 142, 143, 144, 145, 146, 147, 148, 149, 150, 151, 152, 153, 154, 155, 156, 157, 158, 159, 160, 161, 162, 163, 164, 165, 166, 167, 168, 169, 170], q = /\[([A-Z\u4e00-\u9fa5]{1,20}?)\]/gi, w = ["font", {
            ...
            onSendMessage: function(p) {
                if (mq.main.isOnline()) {
                    var y = f.model
                      , F = mq.model.buddylist
                      , H = F.getSelfUin()
                      , M = F.getSelfInfo()
                      , P = f.getCurrentChatUin()
                      , E = f.getCurrentChatType()
                      , G = p.textContent;
                    G = G.replace(q, "@#[$1]@# ");
                    d = G.split("@#");
                    p = d.length;
        ...
        var o = function(p) {
          ...
          , D = function(p) {
            var y = p.attach.from_uin + "_" + p.attach.msg_id
              , F = g.format.date(new Date(p.attach.expire_time * 1E3), "YYYY-MM-DD")
              , H = '<span class="icon icon_info" ></span>\u5bf9\u65b9\u7ed9\u60a8\u53d1\u9001\u79bb\u7ebf\u6587\u4ef6:<br />';
    ...
    J.$package("mq.view.search", function() {
        ...
        var f = {
            clickMemberItem: function(m, r) {
                var k = r.getAttribute("_uin")
                  , d = r.getAttribute("_type");
                c.fire(mq.view, "startChat", {
                    uin: k,
                    type: d
                })
            },
          ...
          , n = {
            onSearchInput: function() {
                if (b.searchInput.value != "")
                    ...
                    e.removeClass(b.searchBar, "hascontent");
                c.fire(b, "searchFriends", {
                    keyword: b.searchInput.value
                })
            }
        };
...
define("mq.view.profile", ["tmpl!../tmpl/tmpl_profile_body.html", "./mq.i18n", "./mq.view.transitionmanager"], function(g) {
    J.$package("mq.view.profile", function() {
        var a = this
          ...
          , e = JM.string
          , j = mq.i18n.message
          , f = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function(r) {
        ...
        var m = {
            ...
            viewGroupMember: function() {
                b.fire(mq.view, "viewGroupMember", {
                    group: n
                })
            },
            viewDiscussMember: function() {
                b.fire(mq.view, "viewDiscussMember", {
                    discuss: n
                })
            },
    ...
    J.$package("mq.view.session", function() {
        ...
        var r = {
            clickMemberItem: function(d, t) {
                var B = t.getAttribute("_uin")
                  , z = t.getAttribute("_type");
                c.fire(mq.view, "startChat", {
                    uin: B,
                    type: z
                });
            ...
            clickMemberAvatar: function(d, t) {
                var B = t.parentNode.getAttribute("_uin")
                  , z = 
        ...
        this.updateMessagePreview = function(d, t) {
            var B = d.send_to || d.from_discuss || d.from_group || d.from_user
              , z = "recent-item-" + (B.type + "-" + B.account)
              , q = e.id(z);
            if (!q) {
    ...
    J.$package("mq.view.contact", function(b) {
        ...
        var n = {
            ...
            clickMemberItem: function(k, d) {
                var t = d.getAttribute("_uin")
                  , B = d.getAttribute("_type");
                e.fire(mq.view, "startChat", {
                    uin: t,
                    type: B
                })
            },
            clickRightButton: function() {
                e.fire(mq.view, "startSearch", {
                    from: f("contact")
                })
            },
            clickLeftButton: function() {}
          ...
          , r = {
            ...
            bindHandlers: function() {
                var k = this
                  , d = this.scroll.options.onScrollEnd;
...
define("mq.view.setting", ["tmpl!../tmpl/tmpl_setting_body.html", "./mq.i18n", "./mq.view.transitionmanager", "../lib/mui/js/mui.select"], function(g) {
    J.$package("mq.view.setting", function() {
        var a = this
          ...
          , e = JM.string
          , j = mq.i18n.message
          , f = ["online", "callme", "away", "busy", "silent", "hidden", "offline"];
        this.createPanel = function() {
            if (!this.panel) {
                var m = {
    ...
    J.$package("mq.presenter.setting", function() {
        ...
        var j = 
        {
            ...
            onNotifySetting: function() {
                a.fire(mq.view, "viewNotifySetting", {
                    from: c("setting")
                })
            },
            onStateChanged: function(f) {
                g.model.sendChangeStatus({
                    newstatus: f.state
                })
            },
            onLogout: function() {
...
define("mq.view.desktopNotification", ["./mq.view.desktopNotificationManager", "./mq.presenter.chat"], function() {
    J.$package("mq.view.desktopNotification", function(g) {
        var a = this
          , b = g.event
          , c = mq.view.desktopNotificationManager
          , e = window
          , j = e.document
          , f = mq.presenter.chat.translateMessage2Text
          , n = []
          , m = {
            onClose: function(r) {
        ...
        this.appendNotification = function(r) {
            ...
            if (r = c.createNotificationWrapper(r.name, {
                icon: r.avatar,
                body: f(r)
            })) {
    ...
    J.$package("mq.view.notifySetting", function() {
        ...
        var r = {
            ...
            clickVoiceSetting: function() {
                b.fire(a, "settingChange", {
                    enableVoice: f.checked || false
                })
            },
            clickNotificationSetting: function() {
                b.fire(a, "settingChange", {
                    enableNotification: n.checked || false
                })
            },
            clickHttpsSetting: function() {
                b.fire(a, "settingChange", {
                    enableHttps: m.checked || false
                })
            },
    ...
    J.$package("mq.main", function(a) {
        ...
        , B = {}, z = {
            ...
            onReLinkSuccess: function(q) {
                ...
                f.startPoll();
                mq.pgvSendClick({
                    hottag: "smartqq.im.relinksuccess"
                })
            },
        ...
        this.gotoLogin = function() {
            ...
            mq.pgvSendClick({
                hottag: "smartqq.portal.jumptologin"
            });
